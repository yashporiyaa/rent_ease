...
const getSelectValue = (status: DeliveryItemStatus) =>
...
export default function DeliveryPage() {
  ...
  const fetchRows = useCallback(
    ...
    try {
      ...
      setRows(res.data as DeliveryRentalItem[]);
    } catch (error) {
      const message =
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      const updated = res.data as DeliveryRentalItem;
  ...
  const noResultsText = useMemo(() => {
    ...
    if (appliedFilters.status === "pending") {
      return "No pending deliveries found for selected filters.";
    }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-[#0e1b17]">Delivery</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Select
              ...
              onValueChange={(value: "all" | "pending" | "picked") =>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="picked">Picked (Delivered)</SelectItem>
              </SelectContent>
            </Select>
          </div>
        ...
        <Table>
          <TableHeader className="bg-slate-50 text-slate-600">
            <TableRow>
              ...
              <TableHead className="px-4 py-3 text-left font-semibold">Pending Picked</TableHead>
            </TableRow>
          </TableHeader>
                ...
                return (
                  <TableRow key={row.id} className="hover:bg-slate-50 transition">
                    ...
                    <TableCell className="px-4 py-3">
                      <Select
                        value={selectedValue}
                        onValueChange={(value: "picked" | "pending") => {
                      ...
                      {row.deliveryStatus === "PICKED" && row.pickedAt ? (
                        <p className="mt-2 text-xs text-slate-600">
                          Picked at: {formatDateTime(row.pickedAt)}
                        </p>
                      ) : null}
                    </TableCell>
                  </TableRow>
